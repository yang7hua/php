...
$mail->Username = '522802009@qq.com';                 // SMTP username
$mail->Password = 'yanghua~!@0908';                           // SMTP password
$mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 465;                                    // TCP port to connect to

$mail->setFrom('522802009@qq.com', 'Mac');
$mail->addAddress('yang7hua@aliyun.com', 'YangHua');     // Add a recipient
