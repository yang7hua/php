...
<?= $form->field($model, 'nickname', ['template'=>'<div class="col-lg-2 text-right">{label}</div><div class="col-lg-3">{input}</div><div class="col-lg-5">{error}</div>'])->textInput(['value'=>$info['nickname']]) ?>
<?php $form::end(); ?>
		</div>
	</div>
