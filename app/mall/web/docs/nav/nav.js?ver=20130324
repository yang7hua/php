function create_menu(basepath)
{
	...
	document.write(
		...
		'<h3>教程</h3>' +
		'<ul>' +
			'<li><a href="'+base+'tutorial/index.html">内容提要</a></li>' +
			'<li><a href="'+base+'tutorial/static_pages.html">加载静态内容</a></li>' +
			'<li><a href="'+base+'tutorial/news_section.html">读取新闻条目</a></li>' +
			'<li><a href="'+base+'tutorial/create_news_items.html">创建新闻条目</a></li>' +
			'<li><a href="'+base+'tutorial/conclusion.html">结束语</a></li>' +
		'</ul>' +
		...
		'<ul>' +
			...
			'<li><a href="'+base+'general/drivers.html">使用 CodeIgniter 适配器</a></li>' +
			'<li><a href="'+base+'general/creating_drivers.html">创建适配器</a></li>' +
			...
			'<li><a href="'+base+'general/profiling.html">调试你的应用程序</a></li>' +
			'<li><a href="'+base+'general/cli.html">以 CLI 方式运行</a></li>' +
			'<li><a href="'+base+'general/managing_apps.html">管理应用程序</a></li>' +
			'<li><a href="'+base+'general/environments.html">处理多环境</a></li>' +
		...
		'<li><a href="'+base+'libraries/input.html">输入类</a></li>' +
		'<li><a href="'+base+'libraries/javascript.html">Javascript 类</a></li>' +
		'<li><a href="'+base+'libraries/loader.html">装载器类</a></li>' +
		'<li><a href="'+base+'libraries/language.html">语言类</a></li>' +
		'<li><a href="'+base+'libraries/migration.html">迁移类</a></li>' +
		'<li><a href="'+base+'libraries/output.html">输出类</a></li>' +
		'<li><a href="'+base+'libraries/pagination.html">分页类</a></li>' +
		'<li><a href="'+base+'libraries/security.html">安全类</a></li>' +
		...
		'<h3>适配器参考</h3>' +
		'<ul>' +
		'<li><a href="'+base+'drivers/caching.html">缓存类</a></li>' +
		...
		'<li><a href="'+base+'helpers/captcha_helper.html">CAPTCHA 辅助函数</a></li>' +
